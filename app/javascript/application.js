...
import "./controllers"
import "./src/jquery-1.12.4"
import "./src/jquery"
// import "./src/bootstrap"
import "./src/chosen"
import "./src/countdown"
// import "./src/jquery.scrollbar"
import "./src/lightbox"
import "./src/magnific-popup"
import "./src/slick"
// import "./src/jquery.zoom"
import "./src/threesixty"
...
window.kaycee_form = kaycee_form;
...
window.kaycee_view_mode_sidebar = kaycee_view_mode_sidebar;
...
window.kaycee_view_mode_nosidebar = kaycee_view_mode_nosidebar;

function kaycee_video() {
  $('.buttonvideo').simpleLightboxVideo();
}
window.kaycee_video = kaycee_video;
...
window.kaycee_title_tooltip = kaycee_title_tooltip;
...
window.kaycee_header_sticky = kaycee_header_sticky;
...
window.kaycee_vertical_menu = kaycee_vertical_menu;
...
window.kaycee_auto_width_vertical_menu = kaycee_auto_width_vertical_menu;
...
window.kaycee_animation_tabs = kaycee_animation_tabs;
...
window.kaycee_init_carousel = kaycee_init_carousel;
...
window.kaycee_countdown = kaycee_countdown;
...
window.kaycee_category_product = kaycee_category_product;
...
window.kaycee_magnific_popup = kaycee_magnific_popup;
...
window.kaycee_better_equal_elems = kaycee_better_equal_elems;
...
window.kaycee_product_gallery = kaycee_product_gallery;
...
window.kaycee_popover_button = kaycee_popover_button;
...
window.kaycee_threesixty = kaycee_threesixty;
